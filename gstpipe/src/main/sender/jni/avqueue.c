...
void packet_queue_init(PacketQueue *q)
{
    ...
    q->mutex = SDL_CreateMutex();  //q->mutex == 0
    q->cond = SDL_CreateCond();   //q->cond == 1
    q->abort_request = 1;
}
...
{
    SDL_LockMutex(q->mutex);   //q->mutex == 0
    q->abort_request = 0;
...
int packet_queue_get(PacketQueue *q, AVPacket *pkt, int block, int *serial)
{
    ...
    //APPLOGI("........ packet_queue_get .............");
    //APPLOGI("........ packet_queue_get %d",q->mutex);
